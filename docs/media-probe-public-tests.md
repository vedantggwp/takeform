...
| Timing and transforms | A short H.264 MOV written at authored `0,20,73,160,230,400 / 600` PTS, plus an 8-by-4 rotated MOV. The probe retains that exact ordered subsequence. It also asserts the full deterministic Apple writer/reader observation `0,0,20,73,160,230,400,570 / 600`, preserving rather than hiding its leading and terminal samples, and reads the AVFoundation track transform. |
