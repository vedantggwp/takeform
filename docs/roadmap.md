...
14 September 2026. Draft issue bodies, ready to create after the repository name is settled. This is a new product. Previous experiments are private research inputs, not its public identity.
...
## 01. Define the product charter and executable feature map
...
## 02. Review candidate components and their release constraints
...
## 03. Compare architectures through the original P-stack arena
...
## 04. Measure renderers and native preview using identical fixtures
...
## 05. Establish the new repository and reproducible developer setup
...
## 06. Implement project state and versioned channel formats
...
## 07. Build the native project workspace
...
## 08. Ingest assets and report quality
...
## 09. Expose agent commands and thoughtful provider settings
...
## 10. Link stories, scripts, scenes and shots
...
## 11. Produce a reversible talking-head rough cut
...
## 12. Fulfil shots through existing, sourced, generated or recorded assets
...
## 13. Compile and edit compositions
...
## 14. Add captions, audio treatment and output presets
...
## 15. Resume batch production and revisions safely
...
## 16. Verify acceptance films and publish v0.1
