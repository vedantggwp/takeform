...
| 4 | Observe first frame | A displayed-frame acknowledgement appears after the page loads. Record request and acknowledgement timestamps. Diagnostic responsiveness budget is at most 1,000 ms. |
...
| 7 | Send rapid seeks | A delayed or old session/snapshot acknowledgement produces a stale notice and does not overwrite the current displayed frame. |
